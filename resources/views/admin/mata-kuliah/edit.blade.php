<x-app-layout>
    ...
    <div class="max-w-lg">
        <div style="background-color: #0F1C2E; border: 1px solid #1e2d42;" class="rounded-lg p-8">
            ...
            <h3 class="text-white text-xl mb-6" style="font-family: 'Playfair Display', serif;">Edit Mata Kuliah</h3>
            <form action="{{ route('admin.mata-kuliah.update', $mataKuliah) }}" method="POST">
                ...
                <div class="mb-5">
                    ...
                    <input type="text" name="kode_matakuliah" value="{{ old('kode_matakuliah', $mataKuliah->kode_matakuliah) }}"
                ...
                <div class="mb-8">
                    ...
                    <select name="sks"
                        ...
                        @foreach([1,2,3,4,5,6] as $sks)
                            <option value="{{ $sks }}" {{ old('sks', $mataKuliah->sks) == $sks ? 'selected' : '' }}>{{ $sks }} SKS</option>
                        @endforeach
                    </select>
                </div>
