<x-app-layout>
    ...
    <div class="max-w-lg">
        <div style="background-color: #0F1C2E; border: 1px solid #1e2d42;" class="rounded-lg p-8">
            ...
            <h3 class="text-white text-xl mb-6" style="font-family: 'Playfair Display', serif;">Tambah Data Mahasiswa</h3>
            <form action="{{ route('admin.mahasiswa.store') }}" method="POST">
                @csrf
                <div class="mb-5">
                    <label class="block text-xs uppercase tracking-widest text-gray-400 mb-2">NPM</label>
                    <input type="text" name="npm" value="{{ old('npm') }}" placeholder="Masukkan NPM..."
                ...
                <div class="mb-8">
                    ...
                    <input type="text" name="nama" value="{{ old('nama') }}" placeholder="Masukkan nama mahasiswa..."
                        style="background-color: #162032; border: 1px solid #2a3a50; color: #ffffff;"
                        class="w-full rounded px-4 py-3 text-sm focus:outline-none focus:border-yellow-600 transition placeholder-gray-600">
