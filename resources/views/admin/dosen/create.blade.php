<x-app-layout>
    ...
    <div class="max-w-lg">
        <div style="background-color: #0F1C2E; border: 1px solid #1e2d42;" class="rounded-lg p-8">
            ...
            <h3 class="text-white text-xl mb-6" style="font-family: 'Playfair Display', serif;">Tambah Data Dosen</h3>
            ...
            <form action="{{ route('admin.dosen.store') }}" method="POST">
                ...
                <div class="flex gap-3">
                    <button type="submit"
                        ...
                        class="text-white px-6 py-2.5 rounded text-sm font-medium hover:opacity-90 transition tracking-wide">
                        Simpan
                    </button>
